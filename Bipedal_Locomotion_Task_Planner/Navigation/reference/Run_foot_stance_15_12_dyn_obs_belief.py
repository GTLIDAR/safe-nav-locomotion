...
if __name__ == '__main__':
    ...
    example_name = 'benchmark_15_12_avoid_collisions_with_dyn_obs'
    jsonfile_name = example_name + ".json"
    trial_name = folder_locn + example_name
    version = '01'
    # slugs = '/home/sudab/Applications/slugs/src/slugs'
    ########## Jonas ##########
    slugs = '../../slugs-master/src/slugs' # Path to slugs executable
...
# 20x20
    ...
    for n in [0]:
        ...
        # write_structured_slugs_no_obs_edit4_height_act_no_turn.write_to_slugs_part_dist(infile, gwg, initial[n], moveobstacles[0], iset,[],
        #                                                            targets[n], vel[n], visdist[n], allowed_states[n],
        #                                                            [],
        #                                                            pg[n], belief_safety=0, belief_liveness=0,
        #                                                            target_reachability=False, PUDO_targets = PUDO_t)

        write_structured_slugs_past_action_foot_stance_MP_specs.write_to_slugs_part_dist(infile, gwg, initial[n], moveobstacles[0], iset,[],
                                                                   targets[n], vel[n], visdist[n], allowed_states[n],
                                                                   [],
                                                                   pg[n], belief_safety=0, belief_liveness=0,
                                                                   target_reachability=False, PUDO_targets = PUDO_t)
        ...
        # write_structured_slugs_past_action_foot_stance_yingke_specs_step_height_23_38_no_step_over.write_to_slugs_part_dist(infile, gwg, initial[n], moveobstacles[0], iset,[],
        #                                                            targets[n], vel[n], visdist[n], allowed_states[n],
        #                                                            [],
        #                                                            pg[n], belief_safety=0, belief_liveness=0,
        #                                                            target_reachability=False, PUDO_targets = PUDO_t)
