...
import write_structured_slugs_past_action_foot_stance_MP_specs_collision_allowed_env_live_not_visible_state_step_height
...
if __name__ == '__main__':
    ...
    example_name = 'Jonas_Belief_Evasion_Terminal_Aziz_23_38_vis_12_no_collision_enforcement_step_height'
    ...
    for n in [0]:
        ...
        write_structured_slugs_past_action_foot_stance_MP_specs_collision_allowed_env_live_not_visible_state_step_height.write_to_slugs_part_dist(infile, gwg, initial[n], moveobstacles[0], iset, PUDO_targets = PUDO_t,
                                                                   visdist =  visdist[n], allowed_states = allowed_states[n],
                                                                   partitionGrid = pg[n])
