...
#include "drake/examples/cassie/cassie_turtle.h"
DEFINE_double(simulation_time, 22.2, "Desired duration of the simulation in seconds");
...
void DoMain() {
  ...
  file_name = "/home/yuki/drake/examples/cassie/lists/log_obstacle.txt";
  ...
  full_name = FindResourceOrThrow("drake/examples/mobile_robots/models/turtlebot.urdf");
  parser.AddModelFromFile(full_name);
