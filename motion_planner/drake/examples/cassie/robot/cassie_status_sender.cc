...
CassieStatusSender::CassieStatusSender(int num_joints)
  ...
  this->DeclareAbstractOutputPort(
      "lcmt_cassie_status", &CassieStatusSender::CalcOutput);
}

using InPort = systems::InputPort<double>;
const InPort& CassieStatusSender::get_position_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(0);
}
const InPort& CassieStatusSender::get_position_measured_input_port() const {
  return LeafSystem<double>::get_input_port(1);
}
const InPort& CassieStatusSender::get_velocity_estimated_input_port() const {
  return LeafSystem<double>::get_input_port(2);
}
const InPort& CassieStatusSender::get_torque_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(3);
}
const InPort& CassieStatusSender::get_torque_measured_input_port() const {
  return LeafSystem<double>::get_input_port(4);
}
const InPort& CassieStatusSender::get_torque_external_input_port() const {
  return LeafSystem<double>::get_input_port(5);
}
const systems::OutputPort<double>& CassieStatusSender::get_output_port() const {
...
void CassieStatusSender::CalcOutput(
