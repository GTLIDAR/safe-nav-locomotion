 ...
 public:
  Quadrotor() {
    ...
    DRAKE_DEMAND(plant.num_positions() == 7);
      ...
      drake::log()->info("iiwa num joins: {}",plant.num_positions());
  drake::log()->info("num vels: {}",plant.num_velocities());
  drake::log()->info("num bodies: {}",plant.num_bodies());
  drake::log()->info("num mbp states: {}",plant.num_multibody_states());
