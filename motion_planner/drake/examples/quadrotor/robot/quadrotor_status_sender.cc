...
QuadrotorStatusSender::QuadrotorStatusSender(int num_joints)
  ...
  this->DeclareAbstractOutputPort(
      "lcmt_quadrotor_status", &QuadrotorStatusSender::CalcOutput);
}

using InPort = systems::InputPort<double>;
const InPort& QuadrotorStatusSender::get_position_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(0);
}
const InPort& QuadrotorStatusSender::get_position_measured_input_port() const {
  return LeafSystem<double>::get_input_port(1);
}
const InPort& QuadrotorStatusSender::get_velocity_estimated_input_port() const {
  return LeafSystem<double>::get_input_port(2);
}
const InPort& QuadrotorStatusSender::get_torque_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(3);
}
const InPort& QuadrotorStatusSender::get_torque_measured_input_port() const {
  return LeafSystem<double>::get_input_port(4);
}
const InPort& QuadrotorStatusSender::get_torque_external_input_port() const {
  return LeafSystem<double>::get_input_port(5);
}
const systems::OutputPort<double>& QuadrotorStatusSender::get_output_port() const {
...
void QuadrotorStatusSender::CalcOutput(
    const systems::Context<double>& context, lcmt_quadrotor_status* output) const {
  ...
  lcmt_quadrotor_status& status = *output;
