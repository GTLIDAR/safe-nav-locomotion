...
using drake::systems::BasicVector;
  ...
  {  
    ...
    position_measured_output_port_ = 
        ...
        &Quadrotor::CopyDiscreteStateOut).get_index();
  ...
  void Quadrotor::InitSystem(
      std::vector<Eigen::Matrix<double, 3, 1>> location_l)
  {
      location_list = location_l;
  }

  void Quadrotor::DoCalcDiscreteVariableUpdates(
      ...
      drake::systems::DiscreteValues<double>* updates) const
  {
    ...
    {
      drake::log()->info("Quadrotor: Either plan finished or Bad quaternion value detected. Setting state to default.");
  ...
  void Quadrotor::CopyDiscreteStateOut(
      const drake::systems::Context<double>& context,
