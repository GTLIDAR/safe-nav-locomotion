...
TurtleStatusSender::TurtleStatusSender(int num_joints)
  ...
  this->DeclareAbstractOutputPort(
      "lcmt_turtle_status", &TurtleStatusSender::CalcOutput);
}

using InPort = systems::InputPort<double>;
const InPort& TurtleStatusSender::get_position_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(0);
}
const InPort& TurtleStatusSender::get_position_measured_input_port() const {
  return LeafSystem<double>::get_input_port(1);
}
const InPort& TurtleStatusSender::get_velocity_estimated_input_port() const {
  return LeafSystem<double>::get_input_port(2);
}
const InPort& TurtleStatusSender::get_torque_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(3);
}
const InPort& TurtleStatusSender::get_torque_measured_input_port() const {
  return LeafSystem<double>::get_input_port(4);
}
const InPort& TurtleStatusSender::get_torque_external_input_port() const {
  return LeafSystem<double>::get_input_port(5);
}
const systems::OutputPort<double>& TurtleStatusSender::get_output_port() const {
...
void TurtleStatusSender::CalcOutput(
    const systems::Context<double>& context, lcmt_turtle_status* output) const {
  ...
  lcmt_turtle_status& status = *output;
