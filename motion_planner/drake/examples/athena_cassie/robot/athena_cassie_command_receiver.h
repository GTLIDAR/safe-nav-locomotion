...
class AthenaCassieCommandReceiver : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(AthenaCassieCommandReceiver)

  explicit AthenaCassieCommandReceiver(int num_joints = kAthenaCassieNumJoints);
