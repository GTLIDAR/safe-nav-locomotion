...
///
/// @system{AthenaCassieStatusSender,
...
class AthenaCassieStatusSender : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(AthenaCassieStatusSender)

  explicit AthenaCassieStatusSender(int num_joints = kAthenaCassieNumJoints);
