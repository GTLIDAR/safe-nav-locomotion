...
AthenaCassieStatusSender::AthenaCassieStatusSender(int num_joints)
  ...
  this->DeclareAbstractOutputPort(
      "lcmt_cassie_status", &AthenaCassieStatusSender::CalcOutput);
}

using InPort = systems::InputPort<double>;
const InPort& AthenaCassieStatusSender::get_position_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(0);
}
const InPort& AthenaCassieStatusSender::get_position_measured_input_port() const {
  return LeafSystem<double>::get_input_port(1);
}
const InPort& AthenaCassieStatusSender::get_velocity_estimated_input_port() const {
  return LeafSystem<double>::get_input_port(2);
}
const InPort& AthenaCassieStatusSender::get_torque_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(3);
}
const InPort& AthenaCassieStatusSender::get_torque_measured_input_port() const {
  return LeafSystem<double>::get_input_port(4);
}
const InPort& AthenaCassieStatusSender::get_torque_external_input_port() const {
  return LeafSystem<double>::get_input_port(5);
}
const systems::OutputPort<double>& AthenaCassieStatusSender::get_output_port() const {
...
void AthenaCassieStatusSender::CalcOutput(
    const systems::Context<double>& context, lcmt_cassie_status* output) const {
  ...
  lcmt_cassie_status& status = *output;
