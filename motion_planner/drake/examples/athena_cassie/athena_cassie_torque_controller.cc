#include "drake/examples/athena_cassie/athena_cassie_torque_controller.h"
...
template <typename T>
AthenaCassieTorqueController<T>::AthenaCassieTorqueController(
...
template class AthenaCassieTorqueController<double>;
