...
class MoveIkDemoBase {
 public:
  ...
  // std::optional<robotlocomotion::robot_plan_t> NoPlan(
 ...
 private:
  ...
  int status_count_{0};
  planner::ConstraintRelaxingIk constraint_relaxing_ik;

  Eigen::VectorXd current_q_;
  Eigen::VectorXd current_goal_;
