...
jsonfile_name_obs =trial_name_obs+'agent'+str(0) +'.json'
Simulator.userControlled_partition(filename[0], gwg, pg[0], moveobstacles, invisibilityset, jsonfile_name, jsonfile_name_obs)