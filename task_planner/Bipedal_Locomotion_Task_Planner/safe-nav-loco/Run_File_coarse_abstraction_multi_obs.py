...
if __name__ == '__main__':
    ...
    for n in [0]:
        ...
        write_structured_slugs_rss_coarse_grid_multi_obs.write_to_slugs_part_dist(infile, gwg_c, initial_c[n], moveobstacles_c, iset, PUDO_targets = PUDO_t_c,
