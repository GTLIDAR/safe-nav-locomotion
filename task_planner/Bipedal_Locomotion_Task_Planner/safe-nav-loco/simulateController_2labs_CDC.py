...
def userControlled_partition(filename_c,gwg_c,partitionGrid_c,moveobstacles_c,invisibilityset_c,jsonfile_c,filename_f,gwg_f,partitionGrid_f,moveobstacles_f,invisibilityset_f,jsonfile_f):
    ...
    which_render = 0
    turn = 0
    action = ["blank","S","S","E","E","E","E","N","N","N","W","S","S","S","S","N","W","W","W","W","R","R","R","E","E","E","E","N","R","R","R"]
    time_t = [2.17, 5.05, 7.91, 9.71, 11.26, 12.81, 15.17, 18.53, 21.15, 24.56, 27.15, 29.72, 32.62, 35.26, 38.65, 41.51, 44.15, 47.03, 50.23, 53.11, 54.88, 56.42, 57.94, 59.49, 61.03, 63.35, 66.04, 68.09, 69.63, 71.19, 73.53]
    ...
    while True:
        ...
        while True:
            count += 1
            if time.time()-start_t> (time_t[turn-1]+.1*turn):
                print "time met: " + str(time.time()-start_t) + "       turn: " + str(turn)
