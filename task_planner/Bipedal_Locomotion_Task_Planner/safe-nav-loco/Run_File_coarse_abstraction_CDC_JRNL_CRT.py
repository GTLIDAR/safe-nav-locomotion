...
if __name__ == '__main__':
    ...
    mapname_coarse = 'BeliefEvasion_jrnl_CRT2'
    rownum_c = 7
    colnum_c = 11
    ...
    for n in [0]:
        ...
        write_structured_slugs_rss_coarse_grid_stair_cdc_JRNL_CRT.write_to_slugs_part_dist(infile, gwg_c, initial_c[n], moveobstacles_c[0], iset, PUDO_targets = PUDO_t_c,
