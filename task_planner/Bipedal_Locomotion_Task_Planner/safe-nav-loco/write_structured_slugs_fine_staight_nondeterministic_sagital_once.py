...
def write_to_slugs_part_dist(infile,gw,init,initmovetarget,invisibilityset,PUDO_targets,visset_target = [],targets = [],vel=1,visdist = 5,allowed_states = [],
    ...
    # stri = ""
    # for s in gw.states:
    #     stri += "((orientation=0 & turn=2)) & s={} & forward & (stepL=5) -> s' = {}\n".format(s,gw.transR[s]['N2'][0])
    #     stri += "((orientation=4 & turn=2)) & s={} & forward & (stepL=5) -> s' = {}\n".format(s,gw.transR[s]['E2'][0])
    #     stri += "((orientation=8 & turn=2)) & s={} & forward & (stepL=5) -> s' = {}\n".format(s,gw.transR[s]['S2'][0])
    #     stri += "((orientation=12 & turn=2)) & s={} & forward & (stepL=5) -> s' = {}\n\n".format(s,gw.transR[s]['W2'][0])
    # file.write(stri)

    # stri = ""
    # for s in gw.states:
    #     stri += "((orientation=0 & turn=2)) & s={} & forward & (stepL=6) -> s' = {}\n".format(s,gw.transR[s]['N3'][0])
    #     stri += "((orientation=4 & turn=2)) & s={} & forward & (stepL=6) -> s' = {}\n".format(s,gw.transR[s]['E3'][0])
    #     stri += "((orientation=8 & turn=2)) & s={} & forward & (stepL=6) -> s' = {}\n".format(s,gw.transR[s]['S3'][0])
    #     stri += "((orientation=12 & turn=2)) & s={} & forward & (stepL=6) -> s' = {}\n\n".format(s,gw.transR[s]['W3'][0])
    # file.write(stri)

    # stri = ""
    # for s in gw.states:
    #     stri += "((orientation=0 & turn=2)) & s={} & forward & (stepL=7) -> s' = {}\n".format(s,gw.transR[s]['N5'][0])
    #     stri += "((orientation=4 & turn=2)) & s={} & forward & (stepL=7) -> s' = {}\n".format(s,gw.transR[s]['E5'][0])
    #     stri += "((orientation=8 & turn=2)) & s={} & forward & (stepL=7) -> s' = {}\n".format(s,gw.transR[s]['S5'][0])
    #     stri += "((orientation=12 & turn=2)) & s={} & forward & (stepL=7) -> s' = {}\n\n".format(s,gw.transR[s]['W5'][0])
    # file.write(stri)  
    ...
    ### redo specs, only allow nondeterministic trans when not close to a boarder:
    top6_edge = gw.top_edge+gw.top_edge2+gw.top_edge3+gw.top_edge4+gw.top_edge5+gw.top_edge6
    right6_edge = gw.right_edge+gw.right_edge2+gw.right_edge3+gw.right_edge4+gw.right_edge5+gw.right_edge6
    bottom6_edge = gw.bottom_edge+gw.bottom_edge2+gw.bottom_edge3+gw.bottom_edge4+gw.bottom_edge5+gw.bottom_edge6
    left6_edge = gw.left_edge+gw.left_edge2+gw.left_edge3+gw.left_edge4+gw.left_edge5+gw.left_edge6
    edge_6 = top6_edge+right6_edge+bottom6_edge+left6_edge

    # stri_edge = "("
    # for s in edge_6:
    #     stri_edge+="s={} | ".format(s)
    # stri_edge = stri_edge[:-3]
    # stri_edge += ")"  

    # stri_not_edge = "("
    # for s in edge_6:
    #     stri_not_edge+="s!={} & ".format(s)
    # stri_not_edge = stri_not_edge[:-3]
    # stri_not_edge += ")" 

    not_edge = [x for x in gw.states if x not in edge_6]
    ...
    # stri = ""
    # for s in gw.states:
    #     stri += "((orientation=15 & turn=3) | (orientation=1 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['N3'][0],gw.transR[gw.transR[s]['N3'][0]]['E1'][0],gw.transR[gw.transR[s]['N3'][0]]['W1'][0])
    #     stri += "((orientation=3 & turn=3) | (orientation=5 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['E3'][0],gw.transR[gw.transR[s]['E3'][0]]['N1'][0],gw.transR[gw.transR[s]['E3'][0]]['S1'][0])
    #     stri += "((orientation=7 & turn=3) | (orientation=9 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['S3'][0],gw.transR[gw.transR[s]['S3'][0]]['E1'][0],gw.transR[gw.transR[s]['S3'][0]]['W1'][0])
    #     stri += "((orientation=11 & turn=3) | (orientation=13 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={})\n\n".format(s,gw.transR[s]['W3'][0],gw.transR[gw.transR[s]['W3'][0]]['N1'][0],gw.transR[gw.transR[s]['W3'][0]]['S1'][0])
    # file.write(stri)
    ...
    for s in gw.states:
        ...
        stri += "((orientation=7 & turn=3) | (orientation=9 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['S3'][0],gw.transR[gw.transR[s]['S3'][0]]['E1'][0],gw.transR[gw.transR[s]['S3'][0]]['W1'][0],gw.transR[gw.transR[s]['S3'][0]]['E2'][0],gw.transR[gw.transR[s]['S3'][0]]['W2'][0])
        stri += "((orientation=11 & turn=3) | (orientation=13 & turn=1))  & s={} & forward & (stepL=0 | stepL=1) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n\n".format(s,gw.transR[s]['W3'][0],gw.transR[gw.transR[s]['W3'][0]]['N1'][0],gw.transR[gw.transR[s]['W3'][0]]['S1'][0],gw.transR[gw.transR[s]['W3'][0]]['N2'][0],gw.transR[gw.transR[s]['W3'][0]]['S2'][0])
    file.write(stri)
    ...
    # stri = ""
    # for s in gw.states:
    #     stri += "((orientation=15 & turn=4) | (orientation=1 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['N5'][0],gw.transR[gw.transR[s]['N5'][0]]['E1'][0],gw.transR[gw.transR[s]['N5'][0]]['W1'][0])
    #     stri += "((orientation=3 & turn=4) | (orientation=5 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['E5'][0],gw.transR[gw.transR[s]['E5'][0]]['N1'][0],gw.transR[gw.transR[s]['E5'][0]]['S1'][0])
    #     stri += "((orientation=7 & turn=4) | (orientation=9 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['S5'][0],gw.transR[gw.transR[s]['S5'][0]]['E1'][0],gw.transR[gw.transR[s]['S5'][0]]['W1'][0])
    #     stri += "((orientation=11 & turn=4) | (orientation=13 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={})\n\n".format(s,gw.transR[s]['W5'][0],gw.transR[gw.transR[s]['W5'][0]]['N1'][0],gw.transR[gw.transR[s]['W5'][0]]['S1'][0])
    # file.write(stri)

    stri = ""
    for s in gw.states:
        stri += "((orientation=15 & turn=4) | (orientation=1 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['N5'][0],gw.transR[gw.transR[s]['N5'][0]]['E1'][0],gw.transR[gw.transR[s]['N5'][0]]['W1'][0],gw.transR[gw.transR[s]['N5'][0]]['E2'][0],gw.transR[gw.transR[s]['N5'][0]]['W2'][0])
        stri += "((orientation=3 & turn=4) | (orientation=5 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['E5'][0],gw.transR[gw.transR[s]['E5'][0]]['N1'][0],gw.transR[gw.transR[s]['E5'][0]]['S1'][0],gw.transR[gw.transR[s]['E5'][0]]['N2'][0],gw.transR[gw.transR[s]['E5'][0]]['S2'][0])
        stri += "((orientation=7 & turn=4) | (orientation=9 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n".format(s,gw.transR[s]['S5'][0],gw.transR[gw.transR[s]['S5'][0]]['E1'][0],gw.transR[gw.transR[s]['S5'][0]]['W1'][0],gw.transR[gw.transR[s]['S5'][0]]['E2'][0],gw.transR[gw.transR[s]['S5'][0]]['W2'][0])
        stri += "((orientation=11 & turn=4) | (orientation=13 & turn=0))  & s={} & forward & (stepL=4) -> (s'={} | s'={} | s'={} | s'={} | s'={})\n\n".format(s,gw.transR[s]['W5'][0],gw.transR[gw.transR[s]['W5'][0]]['N1'][0],gw.transR[gw.transR[s]['W5'][0]]['S1'][0],gw.transR[gw.transR[s]['W5'][0]]['N2'][0],gw.transR[gw.transR[s]['W5'][0]]['S2'][0])
    file.write(stri)
    ...
    file.write("stepL = 2 -> stepL' = 1\n")
    file.write("turn' != 2 -> stepL' != 0 & stepL' != 5 & stepL' != 6 & stepL' != 7\n")
    file.write("stepL = 0 | stepL = 5 | stepL = 6 | stepL = 7 -> turn' = 2\n")
