...
def write_to_slugs_part_dist(infile,gw,init,initmovetarget,invisibilityset,PUDO_targets,visset_target = [],targets = [],vel=1,visdist = 5,allowed_states = [],
    ...
    file.write("!requestPending1\n")
    file.write("!requestPending2\n")
    # file.write("s_c' != 22 & s_c' != 23 & s_c' != 24 & s_c' != 35 & s_c' != 36 & s_c' != 37 & s_c' != 48 & s_c' != 49 & s_c' != 50 & s_c' != 61 & s_c' != 62 & s_c' != 63 & s_c' != 74 & s_c' != 75 & s_c' != 76\n")
    ...
    file.write('\n[ENV_LIVENESS]\n')
    # stri = "(s_c' != 22 & s_c' != 23 & s_c' != 24 & s_c' != 35 & s_c' != 36 & s_c' != 37 & s_c' != 48 & s_c' != 49 & s_c' != 50 & s_c' != 61 & s_c' != 62 & s_c' != 63 & s_c' != 74 & s_c' != 75 & s_c' != 76"
    # stri += "& (("
    # for visstate in set(nonbeliefstates):
    #     stri += "st = {} \\/ ".format(visstate)
    # stri = stri[:-4]
    ...
    # file.write("st != {} & st' = {}\n".format(allstates[-2],allstates[-2]))
