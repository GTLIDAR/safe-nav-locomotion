...
in [CDC/src/simulate_psp.cc](CDC/src/simulate_psp.cc) and [CDC/src/run_cassie_follow.cc](CDC/src/run_cassie_follow.cc) adjust the path in `file_name = "path/drake/CDC/vis/..."` to match the path to the drake directory on your local machine. 
